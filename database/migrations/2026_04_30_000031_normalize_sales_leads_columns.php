    ...
    public function up(): void
    {
        ...
        Schema::table('sales_leads', function (Blueprint $table) {
            if (! Schema::hasColumn('sales_leads', 'status_id')) {
                $table->unsignedBigInteger('status_id')->nullable()->after('source_channel');
            }
        ...
        if (Schema::hasColumn('sales_leads', 'status')) {
            DB::statement("update sales_leads set status_id = status::bigint where status_id is null and status ~ '^[0-9]+$'");
        }
